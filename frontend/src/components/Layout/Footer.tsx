        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?sortBy=price&sortOrder=asc" className="text-gray-300 hover:text-white">
                  Best Deals
                </Link>
              </li>
              <li>
                <Link to="/products?sortBy=createdAt&sortOrder=desc" className="text-gray-300 hover:text-white">
                  New Arrivals
                </Link>
              </li>
            </ul>
